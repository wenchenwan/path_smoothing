...
PathSmoothing* PathSmoothing::createSmoother(const path_smoothing::PathSmoothing::Options &options,
    ...
    switch (options.smoother_type) {
        ...
        case GAUSS_PROCESS_METHOD: {
            std::cout << "I running here create GpSmoothing !!!" << std::endl;
...
void PathSmoothing::getSmoothPath(std::vector<geometry_msgs::Point> *path,std::vector<geometry_msgs::Point>* ctrol_point) const {
    path->clear();
...
GpSmoothing::GpSmoothing(const Options &options,
    ...
    std::cout << "I running here create GpSmoothing 1 !!!" << std::endl;
    // set robot model
    ...
    //set noise model:
    auto Qc = 0.01*gtsam::Matrix::Identity(3,3);
    ...
    gpmp2::GaussianProcessPriorPose2 factor(key_pose1,
                                                    key_vel1,
                                                    key_pose2,
                                                    key_vel2,
                                                    options.gp_dt,
    ...
    std::cout << "I running here create GpSmoothing 2 !!!" << std::endl;
    ...
    std::cout << "I running here create GpSmoothing 3 !!!" << std::endl;
    gtsam::Key pose_key0;
    gtsam::Key vel_key0;
    for (int i = 0; i < pathSize(); ++i) {
        ...
        std::cout << "I running here create GpSmoothing 4 !!!" << std::endl;
        ...
        if (i > 0) {
            ...
            //GP priors
            gpmp2::GaussianProcessPriorPose2 factor(pose_key0,
                                                    vel_key0,
                                                    pose_key,
                                                    vel_key,
                                                    options.gp_dt,
